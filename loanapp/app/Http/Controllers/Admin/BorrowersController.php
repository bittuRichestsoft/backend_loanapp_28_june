...
class BorrowersController extends Controller
{
	public function index(){
		$users = User::orderBy('id','DESC')->where('user_role' , 2)->get();
		return view('pages.admin.borrowers.index')->with([ 'users' => $users ]);
	}
	...
	public function edit($id){
		$user = User::find($id);
		return view('pages.admin.borrowers.edit')->with([ 'user' => $user ]);
	}
	...
	public function delete(Request $request , $id){
		...
		$delete_user->delete();
		return redirect('admin/borrowers')->with('message','User Deleted successfully');
	}
}