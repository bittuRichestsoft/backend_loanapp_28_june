...
class LendersController extends Controller
{
	public function index(){
		...
		return view('pages.admin.lenders.index')->with([ 'users' => $users ]);
	}

	public function create(){
		return view('pages.admin.lenders.create');
	}
	...
	public function edit($id){
		$user = User::find($id);
		return view('pages.admin.lenders.edit')->with([ 'user' => $user ]);
	}
	...
	public function delete(Request $request , $id){
		...
		$delete_user->delete();
		return redirect('admin/lenders')->with('message','User Deleted successfully');
	}
}