    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <a class='btn btn-primary' href="{{ url('/admin/lenders/create')}}">Add Lender</a>
        </div>
                ...
                @if( $users )
                  @foreach( $users as $users_data )
                    <tr>
                      ...
                      <td>
                        <a class='btn btn-primary' href="{{ url('/admin/lenders/edit')}}/{{ $users_data->id }}">Edit</a>
                        <a class='btn btn-primary' href="{{ url('/admin/lenders/delete')}}/{{ $users_data->id }}">Delete</a>
                      </td>
                    </tr>
                  @endforeach
                @else
