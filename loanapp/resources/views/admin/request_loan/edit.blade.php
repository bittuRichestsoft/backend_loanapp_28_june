...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.loan_requests.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.loan_requests.update", [$requestLoan->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
