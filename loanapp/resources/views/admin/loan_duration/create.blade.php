...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.loan_duration.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group {{ $errors->has('package_name') ? 'has-error' : '' }}">
                <label for="package_name">{{ trans('global.loan_duration.fields.package_name') }}*</label>
                <input type="text" id="package_name" name="package_name" class="form-control" value="{{ old('package_name', isset($loanDuration) ? $loanDuration->package_name : '') }}">
            ...
            <div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
                ...
                <input type="text" id="number" name="number" class="form-control" value="{{ old('name', isset($loanDuration) ? $loanDuration->name : '') }}">
            ...
            <div class="form-group {{ $errors->has('calendar_value') ? 'has-error' : '' }}">
                <label for="calendar_value">{{ trans('global.loan_duration.fields.calendar_value') }}*</label>
