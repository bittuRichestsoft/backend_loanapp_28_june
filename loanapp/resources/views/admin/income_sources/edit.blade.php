...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.income_sources.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.income_sources.update", [$incomeSource->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
