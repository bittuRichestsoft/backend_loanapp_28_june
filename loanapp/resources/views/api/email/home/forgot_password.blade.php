	...
	<div style="padding: 40px; background: #F0F2F2; height: 100%;">
		...
		<table align="center" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="center" bgcolor="#ffffff"
					...
					<img src="{{config('gift3r.logo')}}" alt="logo"
					height="150px" style="display: block;" />
				</td>
			</tr>
			...
			<tr>
				<td align="" bgcolor="#ffffff"
					...
					<p>Gift3r App received a request to reset the password for your account.<br/> 
					To reset your password, click on the button below (or copy/paste the URL into your browser). </p>
				</td>
			</tr>
			<tr>
				...
				<table bgcolor="#8B1E13" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td align="center" height="50"
							...
							class="button"><a href="{{url('merchant/resetPassword?key='.$recovery)}}"
		...
		<tr>
				<td align="" bgcolor="#ffffff"
					...
					<p>Note that Gift3r App will never contact you to ask for your password and that we advise against using the same password for Gift3r App and other sites. Once logged in please update your new password to something memorable.</p>
					<p>If you did not change your password or indeed have any questions, please contact us immediately on US <span style="color:#ef4036;">+1602.820.8941</span> or <span style="color:#ef4036;">support@gift3rapp.com</span>.</p>
				</td>
			</tr>
