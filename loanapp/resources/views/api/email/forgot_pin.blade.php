	...
	<div style="padding: 40px; background: #F0F2F2; height: 100%;">
		...
		<table align="center" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td align="" bgcolor="#ffffff"
					...
					<p>Capital App received a request to reset the pin for your account.<br/> 
					To reset your pin, click on the button below (or copy/paste the URL into your browser). </p>
				</td>
			</tr>
			<tr>
				...
				<table bgcolor="#8B1E13" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td align="center" height="50"
							...
							class="button"><a href="{{url('api/resetpin?key='.$recovery)}}"
		...
		<tr>
				<td align="" bgcolor="#ffffff"
					...
					<p>Note that Capital App will never contact you to ask for your password and that we advise against using the same password for Capital App and other sites. Once logged in please update your new password to something memorable.</p>
					<p>If you did not change your password or indeed have any questions, please contact us immediately on US <span style="color:#ef4036;">+12345678</span> or <span style="color:#ef4036;">support@capital.com</span>.</p>
				</td>
			</tr>
